...
\newcommand{\thesisname}{Model distribúcie interpunkčných \\ znamienok v rôznych textoch}

% If you are writing a master's thesis, don't forget to add Bc. here.
\newcommand{\thesisauthor}{Bc. Zdenko Németh}
...
\newcommand{\thesischapters}{
     ...
     \input chapters/20-application.tex
    %  \input chapters/30-results.tex
     \input chapters/90-Zaver.tex
}
