...
\noindent
\begin{tabular}{ll}
    \ifenglish{}Study Programme:\else{}Študijný program:   \fi & Aplikovaná informatika\\
    \ifenglish{}Field of Study: \else{}Študijný odbor:     \fi & Informatika\\
...
% include all entries from the .bib even if not cited in text
\nocite{*}
